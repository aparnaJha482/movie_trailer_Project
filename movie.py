...
class Movie:
    """This class consists of variables and way to its subclasses """
...
class Media(Movie):
    ...
    def __init__(self, movie_title, storyline, poster_image, trailer_youtube):
        ...
        Movie.__init__(self, movie_title, storyline)
...
toy_story = Media("Toy story",
                  "story of a boy and his toys that comes to life",
...
krish = Media("krish",
              "story of a boy with supernatural powers",
              "https://upload.wikimedia.org/wikipedia/"
              "en/9/95/Krrish_poster.jpg",
              "https://www.youtube.com/watch?v=y0wzwujpkFg")
wolf_of_wall_street = Media("wolf of wall street",
                            "story of a man rising high and making money ",
                            "https://upload.wikimedia.org/wikipedia/en/d/d8/"
                            "The_Wolf_of_Wall_Street_%282013%29.png",
                            "https://www.youtube.com/watch?v=iszwuX1AK6A")
life_of_pie = Media("life of pie",
                    "story of relation between man and animal",
                    "https://upload.wikimedia.org/wikipedia/en/5/57/"
                    "Life_of_Pi_2012_Poster.jpg",
                    "https://www.youtube.com/watch?v=j9Hjrs6WQ8M")
harry_potter = Media("harry potter",
                     "story of a supernatural kid and his powers",
...
movies = [toy_story, avatar, krish, wolf_of_wall_street, life_of_pie,
          harry_potter]
